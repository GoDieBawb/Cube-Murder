...
public class GuiManager extends AbstractAppState {
  ...
  public void initialize(AppStateManager stateManager, Application app){
    ...
    cubesEaten        = stateManager.getState(PlayerManager.class).cubesEaten;
  ...
  private void initScoreDisplay() {
    ...
    scoreDisplay.setText("Cubes Murdered: " + cubesEaten);
  ...
  private void initTitleDisplay() {
    ...
    titleDisplay.setText("Cube Murder");
  ...
  public void displayScores() {
    ...
    int finalScore = stateManager.getState(PlayerManager.class).cubesEaten;
  ...
  public void update(float tpf) {
    scoreDisplay.setText("Cubes Murdered: " + stateManager.getState(PlayerManager.class).cubesEaten);
    }
